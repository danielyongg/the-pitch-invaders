...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${anybody.variable} ${hankenGrotesk.variable} ${jetbrainsMono.variable} h-full`}>
      <body className="min-h-full antialiased flex flex-col" style={{ backgroundColor: '#10131a', color: '#e1e2ec', fontFamily: 'var(--font-hanken), system-ui, sans-serif' }}>
        <Navbar />
        <main className="flex-1">{children}</main>
        <footer className="border-t border-[rgba(255,255,255,0.1)] bg-[#0b0e15] py-6 text-center text-sm text-[#c3c6d3] font-[var(--font-jetbrains)] tracking-wide">
          <div className="flex items-center justify-center gap-4 mb-3">
            <a href="https://x.com/PitchInvadersID" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="text-[#c3c6d3] hover:text-[#e1e2ec] transition">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://www.instagram.com/pitchinvadersid?igsh=MTc0dTBvOGt2Y3hhNg%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#c3c6d3] hover:text-[#e1e2ec] transition">
            ...
            <a href="https://www.threads.com/@pitchinvadersid?igshid=NTc4MTIwNjQ2YQ==" target="_blank" rel="noopener noreferrer" aria-label="Threads" className="text-[#c3c6d3] hover:text-[#e1e2ec] transition">
            ...
            <a href="https://www.tiktok.com/@pitchinvadersid?_r=1&_t=ZS-97fMfGYoUia" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#c3c6d3] hover:text-[#e1e2ec] transition">
