    ...
    <div className="max-w-4xl mx-auto px-8 py-10">
      ...
      <div className="glass-card rounded-2xl overflow-hidden">
        ...
        {!leaderboard?.length ? (
          ...
          <div>
            <div className="grid grid-cols-[32px_1fr_60px] sm:grid-cols-[60px_1fr_60px_60px_70px_70px_80px_70px] gap-2 sm:gap-3 px-4 sm:px-6 py-3 text-xs font-[var(--font-jetbrains)] tracking-widest uppercase text-[var(--color-text-secondary)] border-b border-[var(--color-border)] bg-[rgba(174,198,255,0.06)]">
              <span>#</span>
              <span>Player</span>
            ...
            {leaderboard.map((entry, idx) => {
              ...
              return (
                <div
                  key={entry.user_id}
                  className={`grid grid-cols-[32px_1fr_60px] sm:grid-cols-[60px_1fr_60px_60px_70px_70px_80px_70px] gap-2 sm:gap-3 px-4 sm:px-6 py-4 items-center border-b border-[var(--glass-05)] last:border-0 transition ${
