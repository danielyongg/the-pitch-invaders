...
export default function CreateLeaguePage() {
  ...
  return (
    <div className="max-w-md mx-auto px-8 py-16">
      <h1 className="font-[var(--font-anybody)] font-bold text-[40px] text-[var(--color-text-primary)] mb-2 [font-variation-settings:'wdth'_100]">Create a League</h1>
      <p className="text-[var(--color-text-secondary)] mb-8">Create a private league and invite your friends</p>
      ...
      <div className="glass-card rounded-2xl p-6">
        <form onSubmit={handleCreate} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-[var(--font-jetbrains)] tracking-wide text-[var(--color-text-secondary)] mb-2">League Name</label>
            <input
